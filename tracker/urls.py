...
from .views import FoodItemCreateView, FoodItemListView, FoodItemDeleteView, FoodEatenCreateView, FoodEatenDeleteView, ProfileView, EditGoalView, FoodHistoryView
...
urlpatterns = [
    ...
    path('foodhistory/', FoodHistoryView, name='foodhistory'),
